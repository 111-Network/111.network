export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL?.replace(/\/$/, "") ?? "https://111.network"

export const SITE_NAME = "111 Network"
export const SITE_TAGLINE = "Free, Secure Communication for Everyone"
